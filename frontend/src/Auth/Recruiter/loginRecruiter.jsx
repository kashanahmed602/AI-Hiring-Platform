...
const login = async (e) => {
    e.preventDefault();
    try{
        const response = await axios.post('http://localhost:3001/api/v1/recruiter/login', {
            email,
            password
        },{
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 py-16">
        ...
        <div className="w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3.5 pr-12 rounded-xl border border-slate-200 bg-slate-50/70 outline-none text-sm placeholder:text-slate-400 focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition"
                  />
          ...
          <p className="text-center text-xs text-slate-400 mt-6">
            AI screening • Smart assessments • Intelligent hiring
          </p>
